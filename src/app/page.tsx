    ...
    >
      ...
      >
        ...
        >
          ...
          {/* CTAs */}
          <div className="mb-1 shrink-0 flex flex-col items-end gap-3">
            ...
            >
              <span className="text-[6px] tracking-[0.2em] font-medium uppercase text-white/50 group-hover:text-white/80 transition-colors">
                ENQUIRE ABOUT THIS PROJECT
              </span>
              <svg className="transform group-hover:translate-x-1 transition-transform text-white/50 group-hover:text-white/80" width="8" height="6" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7 1L11 5M11 5L7 9M11 5H1" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
              </svg>
            </Link>
          </div>
        </motion.div>
...
const App = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      initializePosition();
      // Remove the manual dispatch, Preloader will dispatch it when ENTER is clicked
    }, 50);
